...
class LidarBuffer:
    ...
    def __init__(self, 
        ...
        """
        Initialize LidarBuffer with an optional capture area.
    ...
    def add_data(self, incoming_data: Dict[str, Any], video_path: str = None):
        ...
        After adding, if more than 20 frames are accumulated, the current batch is saved
        ...
        # If more than 20 frames have been accumulated, save the current batch.
        if len(self.raw_data) > 70:
            print("Raw data length exceeded 20 frames. Saving current batch in background...")
